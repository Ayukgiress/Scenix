    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="relative hidden flex-1 flex-col justify-between overflow-hidden p-10 lg:flex">
        ...
        <div className="relative z-10">
          <blockquote className="text-[15px] font-medium leading-relaxed text-foreground">
            "Scenix replaced my desktop editor. The browser-based workflow is faster,
            the cloud rendering is rock solid."
          </blockquote>
          <p className="mt-3 text-[12px] text-muted-foreground">Maya Reyes — Filmmaker & Creator</p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 py-12 lg:w-[480px] lg:shrink-0 lg:border-l lg:border-border">
        ...
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1 text-[13px] text-muted-foreground">Sign in to your Scenix account</p>
